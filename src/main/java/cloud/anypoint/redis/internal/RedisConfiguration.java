...
@Operations({DynamicOperations.class, SearchOperations.class, KeyValueCommandOperations.class, SetCommandOperations.class, ListCommandOperations.class, SortedSetCommandOperations.class})
